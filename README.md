...
- **Automation & integrations** — WhatsApp Cloud API, booking platforms, OTA portals, PDF/Excel pipelines.
...
`Python 3` · `Flask` · `SQLAlchemy` · `Alembic` · `PostgreSQL` · `SQLite` · `APScheduler` · `requests` · `pytest` · `Gunicorn` · `Railway` · `Bootstrap 5` · `vanilla JS` · `PySide6` · `PyInstaller` · `pypdf` · `openpyxl`
